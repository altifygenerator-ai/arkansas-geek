...
const infoBlocks = [
  {
    ...
    text: "This side of Arkansas Geek is currently best approached by email first. Send the vehicle details, what is going on, and what you are hoping to have looked at, and the job can be reviewed from there.",
  },
  {
            ...
            <div className="grid w-full gap-10 lg:grid-cols-[1fr_0.72fr] lg:items-end">
              <div>
                ...
                <p className="lead mt-7">
                  ...
                  air-cooled VW questions and smaller repair needs. For now, VW
                  work is handled case by case while the garage side gets more
                  organized.
                </p>
              ...
              <div className="relative hidden lg:block">
                <div className="rotate-[-2deg] border border-[var(--page-accent-soft)]/35 bg-[rgba(13,17,16,0.82)] p-6 shadow-[var(--shadow-soft)] backdrop-blur-xl">
                  ...
                  <p className="mt-4 leading-8 text-[var(--cream-soft)]">
                    ...
                    major rebuilds and large repair projects are not the focus
                    right now.
                  </p>
                </div>
              </div>
            ...
            <div className="garage-lines p-6 sm:p-10 lg:p-14">
              <div className="max-w-3xl">
                ...
                <p className="mt-6 leading-8 text-[var(--cream-soft)]">
                  VW repair is currently reviewed case by case. Good fit
                  examples may include minor repair needs, brake or
                  suspension-related questions, and smaller maintenance-type
                  work. Major engine rebuilds or large restoration work are not
